...
import { RegionFormComponent } from '../../action-tracker/regions/region-main/dialogs/region-form/region-form.component';
import { Regions, SaveApiData } from '../../action-tracker/regions/region-main/region.model';
import { ConfirmDeleteComponent } from '../../working-hours/equipments/dialogs/confirm-delete/confirm-delete.component';
...
export class RegionsComponent extends UnsubscribeOnDestroyAdapter implements OnInit, AfterViewInit {
