...
import { OT_NextOutages, OT_IEquipments } from 'src/app/admin/outage-tracker/next-outages/site-next-outages.model';
import { NextOutagesService } from '../../next-outages.service';
import { OT_SiteNextOutage } from '../../next-outages.model';
...
export class AddNextOutagesComponent extends UnsubscribeOnDestroyAdapter {
  ...
  buildform(): FormGroup {
    return this.fb.group({
      ...
      wceHours :[this.siteNextOutages.wceHours , [Validators.required]],
  ...
  submit() {
    ...
    this.siteNextOutages.wceHours = +this.outageForm.value.wceHours;
